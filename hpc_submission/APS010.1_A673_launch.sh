...
#SBATCH --output=slurm%j_A673_gDNA_nanoseq.out
...
samplesheet=${HOME}/nanoseq/resources/A673_gDNA_samplesheet.csv
## specify path to out directory
outdir=/data1/shahs3/users/preskaa/APS010.1_Archive/nanoseq
...
nextflow run apsteinberg/nanoseq \
  ...
  -params-file ${HOME}/nanoseq/gDNA_nf-params.json
